...
function atualizarTabela(produtos) {
  ...
  produtos.forEach((produto) => {
    ...
    newRow.innerHTML = `
      ...
      <td><center><button type="button" class="btn btn-danger delete-button" data-product-id="${produto.id}" data-product-name="${produto.nome}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill excluir" viewBox="0 0 16 16">
