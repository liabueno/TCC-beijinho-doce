...
function atualizarTabela(produtos) {
  ...
  produtos.forEach((produto) => {
    ...
    newRow.innerHTML = `
      ...
      <td><button type="button" class="btn btn-danger delete-button" data-product-id="${produto.id}" data-product-name="${produto.nome}"><i class="bi bi-trash"></i></button></td>
    `;
...
async function pesquisarNoFirestore(termo) {
  ...
  const pesquisaQuery = query(
    collectionProdutos,
    orderBy('nome'), // Altere o primeiro orderBy para o campo 'nome'
  ...
  querySnapshot.forEach((doc) => {
    if (doc.data().nome !== "") {
      ...
      newRow.innerHTML = `
        ...
        <td>${doc.data().tipo}</td>
        <td><button type="button" class="btn btn-secondary"><i class="bi bi-pencil"></i></button></td>
        <td><button type="button" class="btn btn-danger delete-button" data-product-id="${doc.id}" data-product-name="${doc.data().nome}"><i class="bi bi-trash"></i></button></td>
        `;
      listagens.appendChild(newRow);
    }
  });
